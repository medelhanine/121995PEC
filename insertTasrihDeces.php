               ...
               <div class="">
                  <div class="card">
                     <div class="card-content">
                        <div class="row">
                           <div class="col-md-9">
                              <form action="insertTasrihDecesDB.php" method="post"   class="tasrihForm"  >
                                 <div class="tab-content">
                                    <?php
                                       $query="SELECT MAX(numero),annee FROM `tasrih_deces`";
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <div class="col-md-6">
                                         <div class="form-group label-floating">
                                            ...
                                            <input type="text" name="annee_deces_hijri"  class="form-control" >
                                         </div>
                                      </div>
                                      <div class="col-md-6">
                                         <div class="form-group label-floating">
                                            <label class="control-label m-label-form"> تاريخ الوفاة </label>
                                            <input type="text" name="date_deces_hijri"  class="form-control " >
                                         </div>
                                      </div>
                                      <!---end date naiss-->
                                      <!--en miladi-->
                                      <div class="col-md-6">
                                         <div class="form-group label-floating">
                                            ...
                                            <input type="text" name="annee_deces_miladi"  class="form-control">
                                         </div>
                                      </div>
                                      <div class="col-md-6">
                                         <div class="form-group label-floating">
                                            <label class="control-label m-label-form droid-arabic-kufi"> موافق ل </label>
                                            <input type="text" name="date_deces_miladi"  class="form-control">
                                         </div>
                                      </div>
                                      <!---end miladi-->
                                      ...
                                      <!---end nom-->
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group label-floating m-input-fr">
                                             ...
                                             <input type="text" name="adresse_deces"  class="form-control">
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group label-floating m-input-fr">
                                             ...
                                             <input type="text" name="annee_naiss_hijri"  class="form-control">
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                       ...
                                       <div class="col-md-4 " style="margin-left: 40% ">
                                          <select name="etat_familiale" class="selectpicker m-label-form" data-style="btn btn-info btn-round" title="الحالة العائلية" data-size="7" >
                                             <option value="celeb" class="m-label-form">عازب(ة) </option>
                                             <option value="marie" class="m-label-form">متزوج(ة) </option>
                                             <option value="divorce" class="m-label-form">مطلق(ة) </option>
                                             <option value="veuf" class="m-label-form">أرمل(ة) </option>
                                          </select>
                                       </div>
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group label-floating">
                                             ...
                                             <input type="text" name="niveau_scolaire"  class="form-control">
                                          </div>
                                       </div>
                                       <!---end -->
                                      ...
                                      <!---end بالأحرف العربية-->
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group label-floating">
                                             ...
                                             <input type="text" name="liaison_avec_deces"  class="form-control">
                                          </div>
                                       </div>
                                       <!---end Adresse-->
