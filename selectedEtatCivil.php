...
$numero_etat_civil = $_GET["numero_etat_civil"];
?>
<!doctype html>
<html lang="en">
              ...
              <div class="modal fade etatCivil" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
               ...
               <!--end modal acte deces-->
                            <div class="card">
                                ...
                                <div class="card-content">
                                  <div class="row" style="margin-right : 3%">
                                    ...
                                    <div class="col-md-6">
                                        <h3 class="droid-arabic-kufi">معلومات الأب </h3>
                                    </div>
                                  </div>
                                    ...
                                    <?php
                                    $query="SELECT `numero_etat_civil`, `numero`, `annee`, `type` FROM `etat_civil` WHERE numero_etat_civil=? AND type=1 ";
                                  ...
                                  {
                                     ?>
                                     <form  action="updateEtatCivilDB.php" method="post" class="updateEtatCivilForm">
                                       <input type="hidden" name="numero_etat_civil" value="<?php echo  $numero_etat_civil ?>">
                                     <div class="row" style="margin-right : 3%">
                                    <div class="col-md-6">
                                      <div class="form-group label-floating">
                                    <label class="control-label m-label-form droid-arabic-kufi">السنة  </label>
                                    <input type="text" name="annee_pere" value="<?php echo $result["annee"] ?>"  class="form-control" required>
                                  </div>
                                    </div>
                                    <div class="col-md-6">
                                      <div class="form-group label-floating">
                                        <label class="control-label m-label-form droid-arabic-kufi">  الرقم </label>
                                        <input type="text" name="numero_pere" value="<?php echo $result["numero"] ?>" class="form-control" required>
                                      </div>
                                      </div>
                                    ...
                                    <?php }else {
                                      ...
                                      <h3 class="droid-arabic-kufi">لا توجد معلومات الأب المرجو إضافتها</h3>
                                      <form class="add_missing_father_data_form" action="add_missing_father_ec.php" method="post">
                                        <input type="hidden" name="numero_etat_civil" value="<?php echo  $numero_etat_civil ?>">
                                        <div class="col-md-6">
                                          <div class="form-group label-floating">
                                        <label class="control-label m-label-form droid-arabic-kufi">السنة  </label>
                                        ...
                                        <div class="col-md-6">
                                          ...
                                          <div class="row">
                                            <div style="text-align: center">
                                              ...
                                              <b class="droid-arabic-kufi">إضافة معلومات الأب </b>
                                              </button>
                                            </div>
                                          </div>
                                  ...
                                  <div class="form-group" id="listChild">
                								 	 <?php
                                   $query="SELECT `numero_etat_civil`, `numero`, `annee`, `type` FROM `etat_civil` WHERE numero_etat_civil=? AND type=2 ";
                                   $pdoResult = $pdoConnect->prepare($query);
                                   $pdoResult->execute(array($numero_etat_civil));
                ...
                if($pdoResult->rowCount()>0)
                {
                                      ...
                                      <input type="text" name="annee" id="anneeChild" value="<?php echo $row["annee"] ?>" class="form-control" required readonly>
                                    </div>
                									  </div>
                									  <div class="col-md-6">
                                      <div class="form-group label-floating" style=" margin-right: 5%;">
                                        <label class="control-label m-label-form droid-arabic-kufi">  الرقم </label>
                                        <input type="hidden" name="original_numero" value="<?php echo $row["numero"] ?>">
                                        <input type="text" name="numero" id="numeroChild" value="<?php echo $row["numero"] ?>" class="form-control" required readonly>
                                      </div>
                									  </div>
                									...
                									<form action="insertChildDB.php" method="post" class="childInsertForm">
                									<div class="addAChild">
                                ...
                                <div class="row">
                                  <hr>
                                  <h3 class="droid-arabic-kufi" style="text-align : center"> معلومات إضافية </h3>
                                 <div class="table-responsive col-md-8" style="margin-left: 20%">
                       <table class="table table-hover droid-arabic-kufi ">
                           <thead class="text-primary">
                             ...
                             <th style="text-align: center"> السنة</th>
                              <th style="text-align: center">الإسم العربي</th>
                               <th style="text-align: center"> الإسم الفرنسي </th>

                           </thead>
                           <tbody>
                             <!--mother info-->
                             <?php
                             $query="SELECT exbirth.numero,exbirth.annee,exbirth.prenom_ar,exbirth.prenom FROM exbirth LEFT JOIN etat_civil ON exbirth.numero = etat_civil.numero AND exbirth.annee = etat_civil.annee WHERE etat_civil.numero_etat_civil =? AND etat_civil.type=0";
                             $pdoResult = $pdoConnect->prepare($query);
                             $pdoResult->execute(array($numero_etat_civil));
                             $result=$pdoResult->fetch();
                           ...
                           if($pdoResult->rowCount()>0)
                           {
                             ...
                             <tr style="text-align: center">
                               <td class="droid-arabic-kufi"> الأم</td>
                               <td><?php echo $result["numero"] ?></td>
                               <td><?php echo $result["annee"] ?></td>
                               <td class="droid-arabic-kufi"> <?php echo $result["prenom_ar"] ?></td>
                           ...
                           <?php } ?>
                             ...
                             <!--father info-->
                             <?php
                             $query="SELECT exbirth.numero,exbirth.annee,exbirth.prenom_ar,exbirth.prenom FROM exbirth LEFT JOIN etat_civil ON exbirth.numero = etat_civil.numero AND exbirth.annee = etat_civil.annee WHERE etat_civil.numero_etat_civil =? AND etat_civil.type=1";
                             $pdoResult = $pdoConnect->prepare($query);
                             $pdoResult->execute(array($numero_etat_civil));
                             $result=$pdoResult->fetch();
                           ...
                           if($pdoResult->rowCount()>0)
                           {
                             ?>
                             <tr style="text-align: center">
                               <td class="droid-arabic-kufi"> الأب</td>
                               <td><?php echo $result["numero"] ?></td>
                               <td><?php echo $result["annee"] ?></td>
                               <td class="droid-arabic-kufi"> <?php echo $result["prenom_ar"] ?></td>
                               <td><?php echo $result["prenom"] ?></td>
                           ...
                           <?php } ?>
                             ...
                             <!--children info-->
                             <?php
                             $query="SELECT exbirth.numero,exbirth.annee,exbirth.prenom_ar,exbirth.prenom FROM exbirth LEFT JOIN etat_civil ON exbirth.numero = etat_civil.numero AND exbirth.annee = etat_civil.annee WHERE etat_civil.numero_etat_civil =? AND etat_civil.type=2";
                             $pdoResult = $pdoConnect->prepare($query);
                             $pdoResult->execute(array($numero_etat_civil));
                             $result=$pdoResult->fetchAll();
                             $i=1;
                           if($pdoResult->rowCount()>0)
                           {
                             ...
                             ?>
                             <tr style="text-align: center">
                               <td class="droid-arabic-kufi">   الإبن <?php echo $i ?></td>
                               <td><?php echo $row["numero"] ?></td>
                               <td><?php echo $row["annee"] ?></td>
                               <td class="droid-arabic-kufi"> <?php echo $row["prenom_ar"] ?></td>
                       ...
                       <br><br>
                                ...
                                <!--delete etat civil-->
                                  ...
                                  <div class="row">
                                    <div style="text-align: center">
                                      <button type="button" class="btn btn-default" id="delEtatCivil" data-numero_etat_civil_del="<?php echo $numero_etat_civil ?>" >
                                      <span class="btn-label">
                                      <i class="material-icons">close</i>
                                      </span>
                                      <b class="droid-arabic-kufi"> حذف الحالة المدنية </b>
                                      </button>
                                    </div>
                                  </div>

                                <!--end delete etat civil-->
...
$(document).ready(function () {
  ...
  $("#numeroChild,#anneeChild").prop('readonly', false);
      $(".updateFormBtn").toggle();
  });
});
...
$("#addChild").click(function () {
      ...
      $(".addAChild").append(`
        ...
        <div class="col-md-6">
          <div class="form-group label-floating">
        <label class="control-label m-label-form droid-arabic-kufi"> السنة </label>
        <input type="text" name="annee" value="" class="form-control" required >
      </div>
      </div>
      <div class="col-md-6">
        <div class="form-group label-floating">
      ...
      <span class="btn-label"><i class="material-icons">save</i></span><b class="droid-arabic-kufi">حفظ معلومات الإبن</b></button>
        `);
...
$(document).ready(function(){
    ...
    $(document).on('click', '#delEtatCivil', function(e){
      console.log("delete etat civil");

	var numero_etat_civil_del = $(this).data('numero_etat_civil_del');

	swalDelete(numero_etat_civil_del);
 		e.preventDefault();
...
//delete child
  ...
  var numero_etat_civil = $(this).data('numero_etat_civil');
  var annee = $(this).data('annee');
  var numero = $(this).data('numero');

  swalDeleteChild(numero_etat_civil,numero,annee);
...
function swalDelete(numero_etat_civil_del)
{
			swal({
			title: 'متأكد من هذه العملية؟',
			text: " الحذف بصفة نهائية ",
			type: 'warning',
			...
			preConfirm: function() {
			  return new Promise(function(resolve) {
			     ...
			     $.ajax({
			   		url: 'delEtatCivilDB.php',
			    	type: 'POST',
			       	data: {'numero_etat_civil_del' : numero_etat_civil_del},
			       	dataType: 'html'
			     })
			     .done(function(response){
             swal({
             title: "تمت العملية بنجاح ",
             text: "تم حذف كناش الحالة المدنية ",
             type: "success"
         });
...
//delete child
function swalDeleteChild(numero_etat_civil,numero,annee)
{

		swal({
		title: 'متأكد من هذه العملية؟',
		text: "سيتم حذف معلومات الإبن بصفة نهائية",
		type: 'warning',
		showCancelButton: true,
		confirmButtonColor: '#3085d6',
		cancelButtonColor: '#d33',
		...
		preConfirm: function() {
			return new Promise(function(resolve) {
				 ...
				 $.ajax({
					url: 'deleteChild.php',
					type: 'POST',
						data: {'numero_etat_civil':numero_etat_civil,'numero' : numero,'annee':annee},
						dataType: 'html'
				 })
				 .done(function(response){
					// console.log(response);
					swal('تم حذف معلومات الإبن من الكناش', response.message, response.status);
				$('#listChild').html(response);
				 })
				 .fail(function(){
					swal('Oops...', 'quelque chose ca marche pas!', 'error');
				 });
...
//update father info
$(document).ready(function(){
$('form.updateEtatCivilForm').on('submit',function(){
var that = $(this),
url = that.attr('action'),
type=that.attr('method'),
data = {};
...
$.ajax({
 ...
 data:data,
 success: function(data){
   if(data=="already exists" || data=="no data found")
     {
       $.notify({
       icon: "notifications",
...
//insert fater info
$(document).ready(function(){
$('form.add_missing_father_data_form').on('submit',function(){
var that = $(this),
url = that.attr('action'),
type=that.attr('method'),
data = {};
