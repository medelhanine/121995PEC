...
$request2['start'] = 0;
$request2['length'] = 100;
$sql.="  LIMIT ".$request2['start']." ,".$request2['length']."   ";
$query = mysqli_query($mysqli,$sql);
$data = array();
...
while($row=mysqli_fetch_array($query))
{
  ...
  {
      $subdata[]='<div style="text-align: center;font-size: 0.95em;">feminin</div>';
  }else {
      $subdata[]='<div style="text-align: center;font-size: 0.95em;">masculin</div>';
  }
