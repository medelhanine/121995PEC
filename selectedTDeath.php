            ...
            <div class="content">
              ...
              <div class="modal fade etatCivil" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
               ...
               <!--end modal acte deces-->
                              ...
                              <button class="btn btn-info m-margin-left" id="addTorra">
									  <span class="btn-label">
									  <i class="material-icons">add</i>
									  </span>
									  <b class="droid-arabic-kufi">إضافة طرة</b>
									  </button>
                                </div>
								...
								<div class="card-content">
								 	...
								 	<div class="form-group" id="listTora">
								 	 <?php
...
if($pdoResult->rowCount()>0)
{
										...
										<input type="hidden" name="id" value="<?php echo $row["id"] ?>">
									  	<div class="col-md-6">
									  	<textarea class="form-control m-input-fr" row="5"   name="content_fr" style="white-space: normal;" disabled><?php echo $row["content_fr"] ?></textarea>
									  	
									  	
									  </div>
									  <div class="col-md-6">
									  	<textarea class="form-control droid-arabic-kufi" row="5"   name="content_ar" style="white-space: normal;" disabled><?php echo $row["content_ar"] ?></textarea>
									...
									<form action="insertToraDeathDB.php" method="post" class="tDeathInsertForm">
									<div class="addedTora">
...
<script>
	...
	$("#addTorra").click(function () {

				$(".addedTora").append('<input type="hidden" name="numero" value="<?php echo $request["numero"] ?>"><input type="hidden" name="annee" value="<?php echo $request["annee"] ?>"><div class="row"><div class="form-group"><h4 class="droid-arabic-kufi">  إضافة طرة جديدة</h4><div class="col-md-6"> <textarea class="form-control m-input-fr" row="5"   name="content_fr" placeholder="Le contenu..."></textarea></div><div class="col-md-6"> <textarea class="form-control" row="5"   name="content_ar" placeholder="محتوى الطرة"></textarea></div></div></div><button type="submit" class="btn btn-danger m-margin-left"><span class="btn-label"><i class="material-icons">save</i></span><b class="droid-arabic-kufi">حفظ الطرة الجديدة</b></button>');
	...
	//insert tora birth script i put it here because doesn't work in other file !!
