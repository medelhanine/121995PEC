...
<html lang="en">
      ...
      <div class="wrapper">
         ...
         <div class="main-panel">
            ...
            <div class="content" style="margin-top: 70px;">
               ...
               <!--Cards for irsal -->
                <div class="row col-md-12" style="margin-top : 2%"> <!--row-->
                        <ul class="nav nav-pills nav-pills-warning droid-arabic-kufi" style="margin-left : 18%">
                           <li >
                           ...
                           <div class="tab-pane " id="takarir"> <!--takarir///////////*********************-->
                              ...
                              <div class="tab-pane" id="jodada"><!--jodada//////////////////////////////////**************-->
   ...
   <script src="assets/js/irsal.js"> </script>
