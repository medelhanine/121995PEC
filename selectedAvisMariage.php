            ...
            <div class="content">
              ...
              <div class="modal fade avis_mariage" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
               ...
               <?php
                ...
                {
                  $query="SELECT * FROM `avis_mariage` WHERE `adad`=? OR `numero_sijil`=?";
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-9">
                           <form action="avis_marriage_P.php" method="post" class="vieCollectForm">
                             <input type="hidden" name="id_avis_mariage" value="<?php echo $result["id_avis_mariage"] ?>">
                                    ...
                                    <div class="row col-md-11 m-form-saisie">
                                       ...
                                       <div class="col-md-6">
                                         <div class="form-group label-floating">
                                            ...
                                            <input type="text" name="ibtidaayia" value="<?php echo $result["tribunal_istinaf"] ?>"  class="form-control">
                                         </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group label-floating">
                                             <label class="control-label m-label-form droid-arabic-kufi"> محكمة الإستئناف </label>
                                             <input type="text" name="istinaf" value="<?php echo $result["tribunal_ibtidaia"] ?>"  class="form-control">
                                          </div>
                                       </div>
                                    </div>
                                 </div><!--end resume avis-->
                                 ...
                                 <div class="tab-pane" id="reference_avis">
                                   ...
                                   <div class="col-md-6">
                                      <div class="form-group label-floating">
                                         ...
                                         <input type="text" name="date_reference" value="<?php echo $result["date"] ?>"  class="form-control">
                                      </div>
                                   </div>
                                   ...
                                   <div class="col-md-4 " style="margin-left: 40% ">
                                      <select name="categorie_avis" class="selectpicker m-label-form droid-arabic-kufi" data-style="btn btn-info btn-round" title=" نوع الرسم " data-size="7" >
                                         <option value="marriage" class="m-label-form" <?php echo ($result["type_rasm"]=='marriage')?'selected':'' ?>>زواج</option>
                                         <option value="tobout" class="m-label-form" <?php echo ($result["type_rasm"]=='tobout')?'selected':'' ?>> ثبوت زوجية </option>
                                         <option value="morajaa" class="m-label-form" <?php echo ($result["type_rasm"]=='morajaa')?'selected':'' ?>>مراجعة </option>
                                         <option value="rijaa" class="m-label-form" <?php echo ($result["type_rasm"]=='rijaa')?'selected':'' ?>>رجعة</option>
                                      </select>
                                   </div>
                                   ...
                                   <div class="col-md-6">
                                      <div class="form-group label-floating">
                                         ...
                                         <input type="text" name="date_avis" value="<?php echo $result["tarikh_rasm"] ?>" id="date_avis" class="form-control">
                                      </div>
                                   </div>
                                  ...
                                  <div class="tab-pane" id="info_husband">
                                    <div class="col-md-6">
                                       <div class="form-group label-floating ">
                                          <label class="control-label m-label-form droid-arabic-kufi"> السنة </label>
                                          <input type="text" name="annee_husband" value="<?php echo $result["annee_epoux"] ?>" id="annee_husband" class="form-control" required>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group label-floating">
                                          ...
                                          <input type="text" name="numero_husband" value="<?php echo $result["numero_epoux"] ?>" id="numero_husband" class="form-control" required>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group label-floating m-input-fr" id="prenom_nom">
                                          ...
                                          <input type="text" name="prenom_nom"  value="<?php echo $result["nom_epoux"] ?>" class="form-control" required>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group label-floating" id="prenom_nom_ar">
                                          ...
                                          <input type="text" name="prenom_nom_ar" value="<?php echo $result["nom_epoux_ar"] ?>" id="nom_husb" class="form-control" required>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group label-floating" id="date_naiss_num">
                                         ...
                                         <input type="text" name="date_naiss_num" value="<?php echo $result["date_naiss_epoux_num"] ?>" class="form-control">
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group label-floating" id="date_naiss">
                                          ...
                                          <input type="text" name="date_naiss" value="<?php echo $result["date_naiss_epoux"] ?>" class="form-control">
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group label-floating ">
                                          ...
                                          <input type="text" name="nationalite" value="<?php echo $result["nationalite_epoux"] ?>" value="<?php echo $nationalite_ar  ?>" class="form-control">
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group label-floating">
                                          ...
                                          <input type="text" name="profession" value="<?php echo $result["profession_epoux"] ?>"  class="form-control">
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 " style="margin-left: 40% ">
                                       <select name="etat_familiale" class="selectpicker m-label-form droid-arabic-kufi" data-style="btn btn-info btn-round" title="الحالة العائلية" data-size="7" >
                                          <option value="celeb" class="m-label-form" <?php echo ($result["etat_familiale_epoux"]=='celeb')?'selected':'' ?>>عازب(ة) </option>
                                          <option value="marie" class="m-label-form" <?php echo ($result["etat_familiale_epoux"]=='marie')?'selected':'' ?>>متزوج(ة) </option>
                                          <option value="divorce" class="m-label-form" <?php echo ($result["etat_familiale_epoux"]=='divorce')?'selected':'' ?>>مطلق(ة) </option>
                                          <option value="veuf" class="m-label-form" <?php echo ($result["etat_familiale_epoux"]=='veuf')?'selected':'' ?>>أرمل(ة) </option>
                                       </select>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group label-floating">
                                         ...
                                         <input type="text" name="adress" value="<?php echo $result["adresse_epoux"] ?>" class="form-control">
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group label-floating " id="lieu_naiss">
                                         ...
                                         <input type="text" name="lieu_naiss" value="<?php echo $result["lieu_naiss_epoux"] ?>" class="form-control">
                                      </div>
                                    </div>
                                  ...
                                  <div class="tab-pane" id="info_wife">
                                    <div class="col-md-6">
                                       <div class="form-group label-floating " >
                                          <label class="control-label m-label-form droid-arabic-kufi"> السنة </label>
                                          <input type="text" name="annee_wife" value="<?php echo $result["annee_epouse"] ?>" id="annee_wife" class="form-control" required>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group label-floating" >
                                          <label class="control-label m-label-form droid-arabic-kufi">رقم الرسم </label>
                                          <input type="text" name="numero_wife" value="<?php echo $result["numero_epouse"] ?>" id="numero_wife" class="form-control" required>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group label-floating m-input-fr" id="prenom_nom_wife">
                                          <label class="control-label m-label-form droid-arabic-kufi"> Prénom et Nom</label>
                                          <input type="text" name="prenom_nom_wife" value="<?php echo $result["nom_epouse"] ?>" class="form-control" required>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group label-floating" id="prenom_nom_ar_wife">
                                          <label class="control-label m-label-form droid-arabic-kufi"> الإسم الشخصي و العائلي </label>
                                          <input type="text" name="prenom_nom_ar_wife" value="<?php echo $result["nom_epouse_ar"] ?>" id="nom_wife" class="form-control" required>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group label-floating" id="date_naiss_num_wife">
                                         ...
                                         <input type="text" name="date_naiss_num_wife" value="<?php echo $result["date_naiss_epouse_num"] ?>"  class="form-control">
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group label-floating" id="date_naiss_wife">
                                          ...
                                          <input type="text" name="date_naiss_wife" value="<?php echo $result["date_naiss_epouse"] ?>" class="form-control">
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group label-floating ">
                                          ...
                                          <input type="text" name="nationalite_wife" value="<?php echo $result["nationalite_epouse"] ?>" value="<?php echo $nationalite_ar ?>"  class="form-control">
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group label-floating">
                                          ...
                                          <input type="text" name="profession_wife" value="<?php echo $result["profession_epouse"] ?>"  class="form-control">
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 " style="margin-left: 40% ">
                                       <select id="etat_familiale_select" name="etat_familiale_wife" class="selectpicker m-label-form droid-arabic-kufi" data-style="btn btn-info btn-round" title="الحالة العائلية" data-size="7" >
                                          <option value="celeb_wife" class="m-label-form" <?php echo ($result["etat_familiale"]=='celeb_wife')?'selected':'' ?>>بكر (لم يسبق لها الزواج) </option>
                                          <option value="divorce_wife" class="m-label-form" <?php echo ($result["etat_familiale"]=='divorce_wife')?'selected':'' ?>>مطلقة </option>
                                          <option value="veuf_wife" class="m-label-form" <?php echo ($result["etat_familiale"]=='veuf_wife')?'selected':'' ?>>أرملة</option>
                                       </select>
                                    </div>
                                    ...
                                    <div id="veuf_wife" class="etat_familiale_wife" style="display:none">
                                      ...
                                      <div class="col-md-6">
                                         <div class="form-group label-floating">
                                            ...
                                            <input type="text" name="date_deces_marie" value="<?php echo $result["date_deces_epoux"] ?>"  class="form-control">
                                         </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group label-floating">
                                         ...
                                         <input type="text" name="adress_wife" value="<?php echo $result["adress_epouse"] ?>" class="form-control">
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group label-floating " id="lieu_naiss_wife">
                                         ...
                                         <input type="text" name="lieu_naiss_wife" value="<?php echo $result["lieu_naiss_epouse"] ?>" class="form-control">
                                      </div>
                                    </div>
                                  </div><!-- end info wife-->
                                  ...
                                  $pdoResult2->execute(array($result["numero_epoux"],$result["annee_epoux"]));
                                  ...
                                  <div class="tab-pane" id="add_tora">
                                      <div class="col-md-6">
                                          <textarea class="form-control m-input-fr" row="10"  name="tora_fr" id="tora_fr" style="white-space: normal;" placeholder="Le contenu....." ><?php echo $result2["content_fr"] ?></textarea>                                                
                                            
                                      </div>
                                      <div >
                                      <div class="col-md-6" >                                          
                                              <textarea class="form-control " row="10"  name="tora_ar" id="tora_ar" style="white-space: normal;" placeholder="محتوى الطرة" ><?php echo $result2["content_ar"] ?></textarea> 
                                        </div>
                                      </div>    
                           ...
                           <button type="submit" name="print_avis" class="btn btn-info m-margin-left" id="sendVieCollectForm">
                           <span class="btn-label">
                           <i class="material-icons">print</i>
                           </span>
                           <b class="droid-arabic-kufi">طباعة البيان</b>
                           </button>                            
