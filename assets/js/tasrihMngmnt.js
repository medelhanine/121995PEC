        ...
        $.notify(
          {
            icon: "notifications",
            message:
              '<h6 class="droid-arabic-kufi" style="margin-right:5%;margin:0!important">تم الحفظ بنجاح </h6>'
          },
          {
            type: "success",
            timer: 3000,
        ...
        $.notify(
          {
            icon: "notifications",
            message:
              '<h6 class="droid-arabic-kufi" style="margin-right:5%;margin:0!important">فشلت الاضافة </h6>'
          },
          {
            type: "danger",
            timer: 3000,
        ...
        $.notify(
          {
            icon: "notifications",
            message:
              '<h6 class="droid-arabic-kufi" style="margin-right:5%;margin:0!important">تم التغيير بنجاح </h6>'
          },
          {
            type: "success",
            timer: 3000,
        ...
        $.notify(
          {
            icon: "notifications",
            message:
              '<h6 class="droid-arabic-kufi" style="margin-right:5%;margin:0!important">فشلت العملية </h6>'
          },
          {
            type: "danger",
            timer: 3000,
    ...
    success: function(data) {
      ...
      $("#prenom_ar").replaceWith(
        `<div class="form-group label-floating" id="prenom_ar">
				 ...
				 <input type="text" name="prenom_ar" value="` +
          data["prenom_naiss"] +
          `" class="form-control">
			</div>`
      );
	 ...
	 <input type="text" name="nom_ar" value="` +
          data["nom_naiss"] +
          `" class="form-control">
</div>`
      );
	 ...
	 <input type="text" name="lieu_naiss_ar" value="` +
          data["lieu_naiss"] +
          `" class="form-control">
</div>`
      );
	 ...
	 <input type="text" name="date_naiss_hijri_ar" value="` +
          data["date_naiss_hijri"] +
          " " +
          data["annee_naiss_hijri"] +
          `" class="form-control">
</div>`
      );
	 ...
	 <label class="control-label m-label-form droid-arabic-kufi">بالأحرف العربية</label>
	 <input type="text" name="date_naiss_miladi_ar" value="` +
          data["date_naiss_miladi"] +
          " " +
          data["annee_naiss_miladi"] +
          `"  class="form-control">
</div>`
      );
	 ...
	 <label class="control-label m-label-form droid-arabic-kufi">بالأحرف العربية</label>
	 <input type="text" name="date_naiss_pere_hijri_ar" value="` +
          data["date_naiss_pere_hijri"] +
          " " +
          data["annee_naiss_pere_hijri"] +
          `" class="form-control">
</div>`
      );
	 ...
	 <label class="control-label m-label-form droid-arabic-kufi">بالأحرف العربية</label>
	 <input type="text" name="date_naiss_pere_miladi_ar" value="` +
          data["date_naiss_pere_miladi"] +
          " " +
          data["annee_naiss_pere_miladi"] +
          `" class="form-control">
</div>`
      );

      $("#lieu_naiss_pere").replaceWith(
        `<div class="form-group label-floating" id="lieu_naiss_pere">
	 <label class="control-label m-label-form droid-arabic-kufi">مكان الازدياد</label>
	 <input type="text" name="lieu_naiss_pere_ar" value="` +
          data["lieu_naiss_pere"] +
          `" class="form-control">
</div>`
      );
	 ...
	 <input type="text" name="nationalite_pere_ar" value="` +
          data["nationalite_pere"] +
          `" class="form-control">
</div>`
      );
	 ...
	 <input type="text" name="profession_pere_ar" value="` +
          data["profession_pere"] +
          `" class="form-control">
</div>`
      );

      $("#niveau_scol_pere").replaceWith(
	 ...
	 <input type="text" name="niveau_scol_pere_ar" value="` +
          data["niveau_scol_pere"] +
          `" class="form-control">
</div>`
      );

      $("#nom_mere_ar").replaceWith(
        `<div class="form-group label-floating" id="nom_mere_ar">
	 <label class="control-label m-label-form droid-arabic-kufi">الاسم </label>
	 <input type="text" name="nom_mere_ar" value="` +
          data["nom_mere"] +
          `" class="form-control">
</div>`
      );

      $("#date_naiss_mere_hijri_ar").replaceWith(
        `<div class="form-group label-floating " id="date_naiss_mere_hijri_ar">
	 <label class="control-label m-label-form droid-arabic-kufi">بالأحرف العربية</label>
	 <input type="text" name="date_naiss_mere_hijri_ar" value="` +
          data["date_naiss_mere_hijri"] +
          " " +
          data["annee_naiss_mere_hijri"] +
          `" class="form-control">
</div>`
      );

      $("#date_naiss_mere_miladi_ar").replaceWith(
        `<div class="form-group label-floating" id="date_naiss_mere_miladi_ar">
	 <label class="control-label m-label-form droid-arabic-kufi">بالأحرف العربية </label>
	 <input type="text" name="date_naiss_mere_miladi_ar" value="` +
          data["date_naiss_mere_miladi"] +
          " " +
          data["annee_naiss_mere_miladi"] +
          `" class="form-control">
</div>`
      );

      $("#lieu_naiss_mere_ar").replaceWith(
        `<div class="form-group label-floating" id="lieu_naiss_mere_ar">
	 <label class="control-label m-label-form droid-arabic-kufi">مكان الازدياد </label>
	 <input type="text" name="lieu_naiss_mere_ar" value="` +
          data["lieu_naiss_mere"] +
          `" class="form-control">
</div>`
      );

      $("#nationalite_mere_ar").replaceWith(
        `<div class="form-group label-floating" id="nationalite_mere_ar">
	 <label class="control-label m-label-form droid-arabic-kufi">الجنسية </label>
	 <input type="text" name="nationalite_mere_ar" value="` +
          data["nationalite_mere"] +
          `" class="form-control">
</div>`
      );

      $("#profession_mere_ar").replaceWith(
        `<div class="form-group label-floating" id="profession_mere_ar">
	 <label class="control-label m-label-form droid-arabic-kufi">المهنة </label>
	 <input type="text" name="profession_mere_ar" value="` +
          data["profession_mere"] +
          `" class="form-control">
</div>`
      );

      $("#niveau_scol_mer_ar").replaceWith(
	 ...
	 <input type="text" name="niveau_scol_mer_ar" value="` +
          data["niveau_scol_mere"] +
          `" class="form-control">
</div>`
      );
	 ...
	 <input type="text" name="ordre_naiss" value="` +
          data["ordre_naiss"] +
          `" class="form-control">
</div>`
      );

      $("#adresse_parent").replaceWith(
	 ...
	 <input type="text" name="adresse_parent_ar" value="` +
          data["adresse_parent"] +
          `" class="form-control">
</div>`
      );
	 ...
	 <input type="text" name="selon_ar" value="` +
          data["selon_annonceur"] +
          `" class="form-control">
</div>`
      );

      $("#annonce_numero").replaceWith(
	 ...
	 <input type="text" name="annonce_numero" value="` +
          data["numero"] +
          `" class="form-control">
</div>`
      );

      $("#age_annonceur").replaceWith(
        `<div class="form-group label-floating" id="age_annonceur">
	 <label class="control-label m-label-form droid-arabic-kufi">عمره </label>
	 <input type="text" name="age_num_ar" value="` +
          data["age_annonceur"] +
          `" class="form-control">
</div>`
      );

      $("#adresse_annonceur").replaceWith(
	 ...
	 <input type="text" name="adresse_annonceur_ar" value="` +
          data["adresse_annonceur"] +
          `" class="form-control">
</div>`
      );

      $("#date_annonce_hijri").replaceWith(
	 ...
	 <input type="text" name="date_annonce_hijri_ar" value="` +
          data["date_ecrit_hijri"] +
          " " +
          data["annee_ecrit_hijri"] +
          `"  class="form-control">
</div>`
      );

      $("#date_annonce_miladi").replaceWith(
	 ...
	 <input type="text" name="date_annonce_miladi_ar" value="` +
          data["date_ecrit_miladi"] +
          " " +
          data["annee_ecrit_miladi"] +
          `" class="form-control">
</div>`
      );

      $("#officier_etat_civil").replaceWith(
	 ...
	 <input type="text" name="officier_etat_civil_ar" value="` +
          data["officier_etat_civil"] +
          `" class="form-control">
</div>`
      );
        ...
        $.notify(
          {
            icon: "notifications",
            message:
              '<h6 class="droid-arabic-kufi" style="margin-right:5%;margin:0!important"> تم إضافة البيانات </h6>'
          },
          {
            type: "success",
            timer: 3000,
        ...
        $.notify(
          {
            icon: "notifications",
            message:
              ' <h6 class="droid-arabic-kufi" style="margin-right:5%;margin:0!important">فشل البحث </h6>'
          },
          {
            type: "danger",
            timer: 3000,
