   ...
   /*---------------------
	...
	var d1 = [[0,30],[1,35],[2,35],[3,30],[4,30],[5,35],[6,32],[7,37],[8,30],[9,35],[10,30],[11,40]];
    ...
    if ($("#line-chart")[0]) {
        $.plot($("#line-chart"), [
			{data: d1, lines: { show: true  }, label: 'Product A', stack: true, color: '#f8bd19' },
            {data: d2, lines: { show: false }, label: 'Product B', stack: true, color: '#A9E200' },
   ...
   /*---------------------
	...
	var d1 = [[0,0],[1,35],[2,35],[3,30],[4,30],[5,5],[6,32],[7,37],[8,30],[9,35],[10,30],[11,35]];
