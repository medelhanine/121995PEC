                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                          <?php
                          $query="SELECT COUNT(numero) FROM sbirth";
                          $pdoResult = $pdoConnect->prepare($query);
                          $pdoResult->execute();
                          $result=$pdoResult->fetch();
                           ?>
                            <div class="card card-stats" style="margin : 10px 0 !important">

                                <div class="card-content">
                                  <div class="col-md-6">
                                    <img class="material-icons" src="svg/add-new-document-green.svg" style="width:60%;height:70%;margin-bottom:30%;margin-right:25%"></img>
                                  </div>
                                  <div class="col-md-6">
                                    <p class="category droid-arabic-kufi"><strong>صلب الولادات</strong></p>
                                    <h3 class="card-title"><?php echo $result["COUNT(numero)"] ?></h3>
                                  </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                          <?php
                          $query="SELECT COUNT(numero) FROM sdeadtable";
                          $pdoResult = $pdoConnect->prepare($query);
                          $pdoResult->execute();
                          $result=$pdoResult->fetch();
                           ?>
                            <div class="card card-stats" style="margin : 10px 0 !important">
                                ...
                                <div class="card-content">
                                  <div class="col-md-6">
                                    <img class="material-icons" src="svg/add-new-document-red.svg" style="width:60%;height:70%;margin-bottom:30%;margin-right:25%"></img>
                                  </div>
                                  <div class="col-md-6">
                                    <p class="category droid-arabic-kufi"><strong> صلب الوفيات </strong></p>
                                    <h3 class="card-title"><?php echo $result["COUNT(numero)"] ?></h3>
                                  </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                          <?php
                          $query="SELECT COUNT(numero) FROM exbirth";
                          $pdoResult = $pdoConnect->prepare($query);
                          $pdoResult->execute();
                          $result=$pdoResult->fetch();
                           ?>
                            <div class="card card-stats" style="margin : 10px 0 !important">
                                ...
                                <div class="card-content">
                                  ...
                                  <div class="col-md-6">
                                    <p class="category droid-arabic-kufi"><strong>عقود الإزدياد</strong></p>
                                    <h3 class="card-title"><?php echo $result["COUNT(numero)"] ?></h3>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                          <?php
                          $query="SELECT COUNT(numero) FROM acte_deces";
                          $pdoResult = $pdoConnect->prepare($query);
                          $pdoResult->execute();
                          $result=$pdoResult->fetch();
                           ?>
                            <div class="card card-stats" style="margin : 10px 0 !important">
                                  ...
                                  <div class="card-content">
                                    ...
                                    <div class="col-md-6">
                                    <p class="category droid-arabic-kufi"><strong> رسوم الوفاة</strong></p>
                                    <h3 class="card-title"><?php echo $result["COUNT(numero)"] ?></h3>
                                </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                          <div class="card" >
                              <div class="card-content">
                                  <div class="col-md-4">
                                    <h4 class="card-title droid-arabic-kufi"> نسبة الذكور و الإناث (الوفيات)
                                    </h4>
                                    <div id="dash1-GenderDeath-chart" class="chart">
                                        <canvas id="doughnutChartDeath" height="300" width="300" ></canvas>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-md-4">
                                    <h4 class="card-title droid-arabic-kufi"> نسبة الذكور و الإناث (الولادات)
                                    </h4>
                                    <div id="dash1-GenderBirth-chart" class="chart">
                                        <canvas id="doughnutChartBirth" height="300" width="300" ></canvas>
                                    </div>
                                  </div>
                              </div>
                          </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card" style="min-height: 350px">
                                ...
                                <div class="card-content">
                                    <h4 class="card-title droid-arabic-kufi"> مبيان الولادات (20 سنة)
                                    </h4>
                                    <div class="chart-edge">
                                        <div id="m_line_chart" style="width:100%;height:200px"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
  ...
  $(document).ready(function(){
    $.ajax({
        ...
        success:function(res)
        {
          ...
          var doughnutChartCanvas = $("#doughnutChartBirth").get(0).getContext("2d");
          var config = {
            type: 'doughnut',
            data: {
              datasets: [{
    ...
    //death gender
    $.ajax({
        url:"statistics_Gender_death.php",
        type: "post",
        data :{tableBirth:"sbirth",tableDeath: "sdeadtable"},
        dataType : "json",
        success:function(res)
        {
          console.log(res);
          // Get context with jQuery - using jQuery's .get() method.
          var doughnutChartCanvasDeath = $("#doughnutChartDeath").get(0).getContext("2d");
          var config = {
            type: 'doughnut',
            data: {
              datasets: [{
           ...
           var myDoughnutChart = new Chart(doughnutChartCanvasDeath, config);
        }
    });
  });
</script>
