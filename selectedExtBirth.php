               ...
               <div class="">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="row">
                                        <div class="col-md-9">
                                             <form action="updateExtBirthDB.php" method="post" class="extBirthFormUpdate">
                                            <div class="tab-content">
											...
											<input type="text" name="numero" value="<?php echo $result["numero"]?>"  class="form-control" readonly>
                                                ...
                                                <!--show the slected images-->
													<div class="row" style="margin-left: 5% !important; ">
														...
														<?php
													$i=1;
													$folder = "uploads/extBirth/".$result["numero"].".".$result["annee"]."/";
 													$images = glob($folder."*.*");
                                               ...
                                               <!-- show image en modale-->
												...
												<!--show the slected images-->
                                                <form action="uploadExtBirthDB.php" class="dropzone" id="myAwesomeDropzone">
                                        ...
                                        <div class="col-md-3 ">
                                            <ul class="nav nav-pills nav-pills-rose nav-stacked">
                                                ...
                                                <li>
                                                 ...
                                                 <li>
                                                    <a href="#infoMom" data-toggle="tab" rel="tooltip" title="معلومات حول الام" data-placement="left">
                                                    <i class="material-icons myPills">keyboard_arrow_left</i>
                                    ...
                                    <button class="btn btn-info m-margin-left" id="submitExtBirthForm" type="submit">
                                            <span class="btn-label">
                                    ...
                                    <!--<button class="btn btn-success m-margin-left" data-numero="<?php echo $result["numero"]?>" data-annee="<?php echo $result["annee"]?>" id="delExtraitBirth">
                                          <span class="btn-label">
                                              <i class="material-icons">close</i>
                                          </span>
                                          <b class="droid-arabic-kufi"> حذف </b>
                                      </button>-->
                                    	<!--<button id="submitExtBirthForm" type="submit" class="btn btn-success btn-round btn-fab btn-fab-regular" rel="tooltip" title="حفظ" >
														<i class="material-icons">save</i>
											</button>-->
                                    </div>
                                </div>
...
<script>
    ...
    $('.extBirthFormUpdate').submit();
});


//DELETE **********
$(document).ready(function(){
    $(document).on('click', '#delExtraitBirth', function(e){
