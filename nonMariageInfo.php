        ...
        <div class="main-panel">
          <nav class="navbar navbar-default navbar-absolute" data-topbar-color="blue">
            ...
            <div class="content">
             ...
             -->
                         <li >
                             <a href="#nonMariApresDeces" role="tab" data-toggle="tab">

                               <h4 class="droid-arabic-kufi m-title-color" style="margin-top:6%">
                                عدم الزواج بعد الوفاة
                              </h4>
                             </a>
                         </li>

                           <li >
                               <a href="#nonMariApresDivorce" role="tab" data-toggle="tab">

                                 <h4 class="droid-arabic-kufi m-title-color" style="margin-top:6%">
                                عدم الزواج بعد الطلاق
                              </h4>
                               </a>
                           </li>

                             <li class="active">
                                 <a href="#nonMari" role="tab" data-toggle="tab">
                                   <h4 class="droid-arabic-kufi m-title-color" style="margin-top:11%">
                                    عدم الزواج
                                  </h4>
                     ...
                     <div class="card-content">
                       ...
                       <div class="tab-content">
                           <div class="tab-pane active" id="nonMari">
                             <form action="nonMariageP.php" method="post">
                             <input type="hidden" name="numero" value="<?php echo $_SESSION['numero'] ?>">
                             <input type="hidden" name="annee" value="<?php echo $_SESSION['numero']  ?>">
                             <div class="row col-md-11 m-form-saisie">
                               ...
                               <div id="ar_non_mari" class="language"><!--arabic side-->
                                 <div class="col-md-6">
                                   <div class="form-group label-floating">
                             ...
                             <div class="form-group label-floating">
                               ...
                               <div id="fr_non_mari" class="language row" style="display:none"><!--frensh side-->
                                 <div class="col-md-6">
                               <div class="form-group label-floating">
                               ...
                               <div class="col-md-6">
                                 <div class="form-group label-floating">
                                   <label class="control-label m-label-form droid-arabic-kufi"> C.I.N.E </label>
                                   <input type="text" name="cine_fr"  class="form-control m-input-fr">
                                 </div>
                                 </div>
                                 <div class="col-md-6">
                               <div class="form-group label-floating">
                               ...
                               <div class="col-md-6">
                                   <div class="form-group label-floating">
                                 <label class="control-label m-label-form droid-arabic-kufi">Profession  </label>
                                 <input type="text" name="profession_fr"  class="form-control m-input-fr">
                               </div>
                                 </div>
                               ...
                               <div id="ar_fr_non_mari" class="language row" style="display:none"><!--arabic and frensh side/////////////////-->
                                 <div class="col-md-6">
                               ...
                               <div class="col-md-6">
                                   <div class="form-group label-floating">
                                 <label class="control-label m-label-form droid-arabic-kufi">Profession  </label>
                                 <input type="text" name="professionB_fr"  class="form-control">
                               </div>
                                 </div>
                                 <div class="col-md-6">
                               <div class="form-group label-floating">
                                 <label class="control-label m-label-form droid-arabic-kufi"> مهنته </label>
                                 <input type="text" name="professionB_ar"  class="form-control">
                               </div>
                               </div>
             ...
             <div class="row col-md-12">
               ...
               <b class="droid-arabic-kufi">عودة</b>
                     ...
                     <div class="tab-pane" id="nonMariApresDivorce"><!--non mariage apres divorce-->
                       <form action="nonMarieApresDivorceP.php" method="post">
                       <input type="hidden" name="numero" value="<?php echo $_SESSION['numero']  ?>">
                       ...
                       <div class="row col-md-11 m-form-saisie">
                         ...
                         <div id="ar_divorce" class="language_divorce"><!--arabic side-->
                           <div class="col-md-6">
                             <div class="form-group label-floating">
                               <label class="control-label m-label-form droid-arabic-kufi"> رقم شهادة المقدم أو الشيخ </label>
                               <input type="text" name="numero_mokadam_ar"  class="form-control">
                         ...
                         <div class="col-md-6">
                           <div class="form-group label-floating">
                             <label class="control-label m-label-form droid-arabic-kufi"> رقم البطاقة الوطنية </label>
                             <input type="text" name="cine_ar"  class="form-control">
                           </div>
                       </div>
                           <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                           <div class="form-group label-floating">
                             <label class="control-label m-label-form droid-arabic-kufi"> اسم الزوج المطلق </label>
                             <input type="text" name="feu_marie_ar"  class="form-control">
                           </div>
                       </div>
                         ...
                         <div id="fr_divorce" class="language_divorce row" style="display:none"><!--frensh side-->
                           <div class="col-md-6">
                         <div class="form-group label-floating">
                           <label class="control-label m-label-form droid-arabic-kufi">Numero de Certificat </label>
                           <input type="text" name="numero_certificat_fr"  class="form-control m-input-fr">
                         ...
                         <div class="col-md-6">
                             <div class="form-group label-floating">
                           <label class="control-label m-label-form droid-arabic-kufi">Nom de Feu marie  </label>
                           <input type="text" name="feu_marie_fr"  class="form-control m-input-fr">
                         </div>
                           </div>
                         ...
                         <div id="ar_fr_divorce" class="language_divorce row" style="display:none"><!--arabic and frensh side/////////////////-->
                           <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                           <div class="form-group label-floating">
                             <label class="control-label m-label-form droid-arabic-kufi"> Nom de feu marie </label>
                             <input type="text" name="feu_marieB_fr"  class="form-control m-input-fr">
                           </div>
                           </div>
                           <div class="col-md-6">
                         <div class="form-group label-floating">
                           <label class="control-label m-label-form droid-arabic-kufi"> اسم الزوج المطلق </label>
                           <input type="text" name="feu_marieB_ar"  class="form-control">
                         </div>
                         </div>
                         </div><!--end arabic && frensh side-->
...
</div><!--end tab non mariage apres divorce-->

<div class="tab-pane" id="nonMariApresDeces"><!--non mariage apres deces//////////////////////////////////////-->
  <form action="nonMarieApresDecesP.php" method="post">
  <input type="hidden" name="numero" value="<?php echo $_SESSION['numero']  ?>">
  <input type="hidden" name="annee" value="<?php echo $_SESSION['annee']  ?>">
  <div class="row col-md-11 m-form-saisie">
    ...
    <div id="ar_deces" class="language_deces"><!--arabic side-->
      <div class="col-md-6">
        <div class="form-group label-floating">
          <label class="control-label m-label-form droid-arabic-kufi"> رقم شهادة المقدم أو الشيخ </label>
          <input type="text" name="numero_mokadam_ar"  class="form-control">
    ...
    <div class="col-md-6">
      <div class="form-group label-floating">
        <label class="control-label m-label-form droid-arabic-kufi"> اسم الزوج المتوفي </label>
        <input type="text" name="feu_marie_ar"  class="form-control">
      </div>
  </div>
    ...
    <div id="fr_deces" class="language_deces row" style="display:none"><!--frensh side-->
      <div class="col-md-6">
    <div class="form-group label-floating">
      <label class="control-label m-label-form droid-arabic-kufi">Numero de Certificat </label>
      <input type="text" name="numero_certificat_fr"  class="form-control m-input-fr">
    ...
    <div id="ar_fr_deces" class="language_deces row" style="display:none"><!--arabic and frensh side/////////////////-->
      <div class="col-md-6">
...
</div><!--end non mariage apres deces///////////////////////////////////////////-->
...
///change the language
$(function() {
  $('#languageSelector_non_mari').change(function(){
    $('.language').hide();
    $('#' + $(this).val()).show();
  });
});
...
$(function() {
  $('#languageSelector_divorce').change(function(){
    $('.language_divorce').hide();
    $('#' + $(this).val()).show();
  });
});
...
$(function() {
  $('#languageSelector_deces').change(function(){
    $('.language_deces').hide();
    $('#' + $(this).val()).show();
  });
});
