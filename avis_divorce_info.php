                                 ...
                                 <div class="tab-pane" id="reference_avis">
                                   ...
                                   <div class="col-md-6">
                                      <div class="form-group label-floating">
                                         ...
                                         <input type="text" name="date_avis"  class="form-control">
                                      </div>
                                   </div>
                                   ...
                                   <div class="col-md-4 " style="margin-left: 40% ">
                                      <select name="categorie_avis" class="selectpicker m-label-form droid-arabic-kufi" data-style="btn btn-info btn-round" title=" نوع الطلاق " data-size="7" >
                                         <option value="rijii" class="m-label-form droid-arabic-kufi">رجعي</option>
                                         <option value="kabl_binae" class="m-label-form droid-arabic-kufi">قبل البناء </option>
                                         <option value="khilii" class="m-label-form droid-arabic-kufi"> خلعي </option>
                                         <option value="momlak" class="m-label-form droid-arabic-kufi">مملك </option>
                                         <option value="mokmil_talat" class="m-label-form droid-arabic-kufi">مكمل للثلاث </option>
                                      </select>
                                   </div>
                                   ...
                                   <div class="col-md-6">
                                     <div class="form-group label-floating">
                                        ...
                                        <input type="text" name="child_number"  class="form-control">
                                     </div>
                                   </div>
                                   <div class="col-md-6">
                                      <div class="form-group label-floating">
                                         <label class="control-label m-label-form droid-arabic-kufi"> مكان إبرام عقد الزواج </label>
                                         <input type="text" name="lieu_acte_marriage"  class="form-control">
                                      </div>
                                   </div>
                                  ...
                                  <div class="tab-pane" id="info_husband">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group label-floating" id="prenom_nom_ar">
                                          ...
                                          <input type="text" name="prenom_nom_ar"  class="form-control" required>
                                       </div>
                                    </div>
                                  ...
                                  <div class="tab-pane" id="info_wife">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group label-floating m-input-fr" id="prenom_nom_wife">
                                          <label class="control-label m-label-form droid-arabic-kufi"> Prénom et Nom</label>
                                          <input type="text" name="prenom_nom_wife"  class="form-control">
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group label-floating" id="prenom_nom_ar_wife">
                                          <label class="control-label m-label-form droid-arabic-kufi"> الإسم الشخصي و العائلي </label>
                                          <input type="text" name="prenom_nom_ar_wife"  class="form-control">
                                       </div>
                                    </div>
