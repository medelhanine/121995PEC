...
<body class="rtl-layout"  style="overflow: hidden !important">
               ...
               <!--end modal acte deces-->
                            <div class="card">
                              <div class="card-header m-card-title-print">
                                <h3 class="droid-arabic-kufi">معلومات حول شهادة عدم التسجيل </h3>

                                <div class="nav-center" style="margin-top: -85px !important;">
                                    <ul class="nav nav-pills nav-pills-warning nav-pills-icons" role="tablist">
                                        <!--
                            color-classes: "nav-pills-primary", "nav-pills-info", "nav-pills-success", "nav-pills-warning","nav-pills-danger"
                        -->
                                      <li >
                                          <a href="#death" role="tab" data-toggle="tab">

                                            <h3 class="droid-arabic-kufi" style="margin-top:11%">
                                              وفاة
                                            </h3>
                                          </a>
                                      </li>
                                        ...
                                        <li class="active">
                                            <a href="#birth" role="tab" data-toggle="tab">
                                              <h3 class="droid-arabic-kufi" style="margin-top:11%">
                                                 ولادة
                                              </h3>
                                ...
                                <div class="card-content">
                                  ...
                                  <form  action="nonInscritBirthP.php" method="post"><!--non Inscrit Birth-->
                                  ...
                                  <div class="row col-md-11 m-form-saisie">
                                    <div class="col-md-4 " style="margin-left: 32% ">
                                      <select id="languageSelector" name="language" class="selectpicker m-label-form" data-style="btn btn-info btn-round" title=" اختيار اللغة " data-size="7" >
                                        <option  value="ar"  class="m-label-form" selected> العربية (ولادة) </option>
                                    ...
                                    <div id="ar" class="language"><!--arabic side-->
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group label-floating">
                                          ...
                                          <input type="text" name="acte_numero_ar"  class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group label-floating">
                                          ...
                                          <input type="text" name="date_certficat_ar"  class="form-control datepicker" value="<?php echo $ActualDate ?>" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                  <div class="form-group label-floating">
                                    <label class="control-label m-label-form droid-arabic-kufi">المسمى(اة)</label>
                                    <input type="text" name="nomme_ar"  class="form-control">
                                  </div>
                                  </div>

                                    <div class="col-md-6">
                                  <div class="form-group label-floating">
                                    <label class="control-label m-label-form droid-arabic-kufi"> اسم الأب</label>
                                    <input type="text" name="nom_pere_ar"  class="form-control">
                                  </div>
                                </div>
                                    <div class="col-md-6">
                                      <div class="form-group label-floating">
                                        <label class="control-label m-label-form droid-arabic-kufi"> تاريخ الإزدياد</label>
                                        <input type="text" name="date_naiss_ar"  class="form-control">
                                      </div>
                                  </div>
                                    ...
                                    <div class="form-group label-floating">
                                      ...
                                      <div class="col-md-6">
                                    <div class="form-group label-floating">
                                      <label class="control-label m-label-form droid-arabic-kufi">اسم الأم</label>
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group label-floating">
                                        <label class="control-label m-label-form droid-arabic-kufi">Acte Numero </label>
                                        <input type="text" name="acte_numero_fr"  class="form-control m-input-fr">
                                      </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group label-floating">
                                        ...
                                        <input type="text" name="lieu_naiss_fr"  class="form-control m-input-fr">
                                      </div>
                                      </div>

                                      <div class="col-md-6">
                                        <div class="form-group label-floating">
                                          <label class="control-label m-label-form droid-arabic-kufi">(Nommé(e </label>
                                          <input type="text" name="nomme_fr"  class="form-control m-input-fr">
                                        </div>
                                      </div>

                                    <div class="col-md-6">
                                      <div class="form-group label-floating">
                                        <label class="control-label m-label-form droid-arabic-kufi"> Nom du père </label>
                                        <input type="text" name="nom_pere_fr"  class="form-control m-input-fr">
                                      </div>
                                      </div>

                                      <div class="col-md-6">
                                        <div class="form-group label-floating">
                                          <label class="control-label m-label-form droid-arabic-kufi"> Date de naissance </label>
                                          <input type="text" name="date_naiss_fr"  class="form-control m-input-fr">
                                        </div>
                                      </div>
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group label-floating">
                                          <label class="control-label m-label-form droid-arabic-kufi">Nom du mère </label>
                                          <input type="text" name="nom_mere_fr"  class="form-control m-input-fr">
                                        </div>
                                      </div>
                                    ...
                                    <div id="ar_fr" class="language row" style="display:none"><!--arabic and frensh side/////////////////-->
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group label-floating">
                                          <label class="control-label m-label-form droid-arabic-kufi">رقم الرسم</label>
                                          <input type="text" name="acte_numeroB"  class="form-control">
                                        </div>
                                      </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group label-floating">
                                      <label class="control-label m-label-form droid-arabic-kufi"> Mokadam ou Cheikh</label>
                                      <input type="text" name="mokadam_cheikhB_fr"  class="form-control m-input-fr">
                                    </div>
                                      </div>
                                      <div class="col-md-6">
                                    <div class="form-group label-floating">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group label-floating">
                                      <label class="control-label m-label-form droid-arabic-kufi">(Nommé(e </label>
                                      <input type="text" name="nommeB_fr"  class="form-control m-input-fr">
                                    </div>
                                      </div>
                                      <div class="col-md-6">
                                    <div class="form-group label-floating">
                                      <label class="control-label m-label-form droid-arabic-kufi"> المسمى(اة)</label>
                                      <input type="text" name="nommeB_ar"  class="form-control">
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group label-floating">
                                      <label class="control-label m-label-form droid-arabic-kufi">Lieu de naissance </label>
                                      <input type="text" name="lieu_naissB_fr"  class="form-control m-input-fr">
                                    </div>
                                      </div>
                                      <div class="col-md-6">
                                      <div class="form-group label-floating">
                                        <label class="control-label m-label-form droid-arabic-kufi">مكان الإزدياد</label>
                                        <input type="text" name="lieu_naissB_ar"  class="form-control">
                                      </div>
                                      </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group label-floating">
                                      <label class="control-label m-label-form droid-arabic-kufi">Date de naissance </label>
                                      <input type="text" name="date_naissB_fr"  class="form-control m-input-fr">
                                    </div>
                                      </div>
                                      <div class="col-md-6">
                                    <div class="form-group label-floating">
                                      <label class="control-label m-label-form droid-arabic-kufi">تاريخ الإزدياد</label>
                                      <input type="text" name="date_naissB_ar"  class="form-control">
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group label-floating">
                                      <label class="control-label m-label-form droid-arabic-kufi">Nom du père </label>
                                      <input type="text" name="nom_pereB_fr"  class="form-control m-input-fr">
                                    </div>
                                      </div>
                                      <div class="col-md-6">
                                    <div class="form-group label-floating">
                                      <label class="control-label m-label-form droid-arabic-kufi">اسم الأب </label>
                                      <input type="text" name="nom_pereB_ar"  class="form-control">
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group label-floating">
                                      <label class="control-label m-label-form droid-arabic-kufi">Nom du mère </label>
                                      <input type="text" name="nom_mereB_fr"  class="form-control m-input-fr">
                                    </div>
                                      </div>
                                      <div class="col-md-6">
                                    <div class="form-group label-floating">
                                      <label class="control-label m-label-form droid-arabic-kufi">اسم الأم </label>
                                      <input type="text" name="nom_mereB_ar"  class="form-control">
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <input type="text" name="domicileB_fr"  class="form-control m-input-fr">
                                    </div>
                                      </div>
                                      <div class="col-md-6">
                                    <div class="form-group label-floating">
  ...
  </form><!--End non Inscrit Birth-->
</div><!--end tab birth-->


                                <div class="tab-pane" id="death"><!--death tab-->
                                  <form  action="nonInscritDecesP.php" method="post"><!--non Inscrit Birth-->

                                  <div class="row col-md-11 m-form-saisie">
                                    <div class="col-md-4 " style="margin-left: 32% ">
                                      <select id="languageSelectorDeath" name="language" class="selectpicker m-label-form" data-style="btn btn-info btn-round" title=" اختيار اللغة " data-size="7" >
                                        <option  value="ar_death"  class="m-label-form" selected> العربية (وفاة)</option>
                                        <option value="fr_death"   class="m-label-form"> الفرنسية </option>
                                        <option value="ar_fr_death"   class="m-label-form"> عربية و فرنسية </option>
                                       </select>
                                    </div>
...
///change the language Death
$(function() {
  $('#languageSelectorDeath').change(function(){
    $('.language').hide();
    $('#' + $(this).val()).show();
  });
});
