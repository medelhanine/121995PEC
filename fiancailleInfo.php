               ...
               <!--end modal acte deces-->
                            <div class="card">
                              <div class="card-header m-card-title-print">
                                <h3 class="droid-arabic-kufi">معلومات شهادة الخطوبة </h3>
                        ...
                        -->
                                      <li >
                                          <a href="#masculin" role="tab" data-toggle="tab">
                                        ...
                                        <li class="active">
                                            <a href="#feminin" role="tab" data-toggle="tab">
                                              <h3 class="droid-arabic-kufi" style="margin-top:11%">
                                                المخطوبة
                                              </h3>
                                ...
                                <div class="card-content">
                                  ...
                                  <div class="tab-content">
                                      <div class="tab-pane active" id="feminin">
                                  <form  action="faincaille_femininP.php" method="post"><!--non Inscrit Birth-->
                                ...
                                <div class="tab-pane" id="masculin"><!--death tab-->
                                  <form  action="faincaille_masculinP.php" method="post"><!--non Inscrit Birth-->
                                  <input type="hidden" name="numero" value="<?php echo $_SESSION['numero'] ?>">
                                  <input type="hidden" name="annee" value="<?php echo $_SESSION['annee'] ?>">
                                  <div class="row col-md-11 m-form-saisie">
                                    <div class="col-md-4 " style="margin-left: 32% ">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <div class="col-md-4 " style="margin-left: 32% ">
                                      <select  name="etat_fammiliale_ar" class="selectpicker m-label-form" data-style="btn btn-info btn-round" title=" الحالة العائلية" data-size="7" >
                                        <option  value="celeb"   class="m-label-form" selected> عازب  </option>
                                        <option  value="marie"   class="m-label-form" > متزوج  </option>
                                        <option value="divorce"  class="m-label-form"> مطلق </option>
                                          <option value="veuf"   class="m-label-form"> أرمل </option>
                                       </select>
                                    </div>
...
$(function() {
  $('#languageSelectorMasculin').change(function(){
    $('.language').hide();
    $('#' + $(this).val()).show();
  });
});
