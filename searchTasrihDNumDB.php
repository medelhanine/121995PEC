...
{
	$query="SELECT `numero`,`annee`,`prenom_deces`,`nom_deces`,`dateInsert` FROM `tasrih_deces` WHERE `numero`=? AND `annee`=?";
	$pdoResult = $pdoConnect->prepare($query);
	$pdoResult->execute(array($numero,$annee));
}
if(trim($numero)=="")
{
	$query="SELECT `numero`,`annee`,`prenom_deces`,`nom_deces`,`dateInsert` FROM `tasrih_deces` WHERE `annee`=?";
	$pdoResult = $pdoConnect->prepare($query);
...
if(trim($annee)=="")
{
	$query="SELECT `numero`,`annee`,`prenom_deces`,`nom_deces`,`dateInsert` FROM `tasrih_deces` WHERE `numero`=?";
	$pdoResult = $pdoConnect->prepare($query);
