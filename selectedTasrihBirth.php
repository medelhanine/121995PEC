   ...
   <body class="rtl-layout"  style="overflow: hidden !important">
      ...
      <div class="sidebar" data-background-color="gray">
               ...
               <div class="">
                  <div class="card">
                     <div class="card-content">
                        <div class="row">
                           <div class="col-md-9">
                              <form action="updateTasrihBirthDB.php" method="post"   class="tasrihBirthFormUpdate"  >
                                 <div class="tab-content">
                                    <?php
                                    ...
                                    <div class="tab-pane" id="infoChild">
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group label-floating m-input-fr">
                                             ...
                                             <input type="text" name="prenom_naiss_fr" value="<?php echo $result["prenom_naiss_fr"]?>" class="form-control">
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group label-floating">
                                             <label class="control-label m-label-form droid-arabic-kufi">الاسم الشخصي</label>
                                             <input type="text" name="prenom_naiss" value="<?php echo $result["prenom_naiss"]?>" class="form-control">
                                          </div>
                                       </div>
                                       <!---end prenom-->
                                       <!--nom-->
                                       <div class="col-md-6">
                                          <div class="form-group label-floating m-input-fr">
                                             ...
                                             <input type="text" name="nom_naiss_fr" value="<?php echo $result["nom_naiss_fr"]?>" class="form-control">
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group label-floating">
                                             <label class="control-label m-label-form droid-arabic-kufi">الاسم العائلي</label>
                                             <input type="text" name="nom_naiss" value="<?php echo $result["nom_naiss"]?>" class="form-control">
                                          </div>
                                       </div>
                                       <!---end nom-->
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group label-floating">
                                             ...
                                             <input type="text" name="annee_naiss_hijri" value="<?php echo $result["annee_naiss_hijri"]?>" class="form-control" value="1439-02-25">
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group label-floating">
                                    ...
                                    <div class="tab-pane" id="infoDad">
                                       ...
                                       <div class="col-md-6">
                                         <div class="form-group label-floating">
                                            ...
                                            <input type="text" name="niveau_scol_pere" value="<?php echo $result["niveau_scol_pere"]?>" class="form-control">
                                         </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group label-floating">
                                    ...
                                    <div class="tab-pane" id="infoMom">
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group label-floating">
                                           ...
                                           <input type="text" name="niveau_scol_mere" value="<?php echo $result["niveau_scol_mere"]?>" class="form-control">
                                        </div>
                                      </div>
                                      <div class="col-md-6">
                                         <div class="form-group label-floating">
                                      ...
                                      <!---end بالأحرف العربية-->
                                       ...
                                       <div class="col-md-6">
                                          <div class="form-group label-floating">
                                             ...
                                             <input type="text" name="liason_avec_naiss" value="<?php echo $result["liason_avec_naiss"]?>" class="form-control">
                                          </div>
                                       </div>
                                       <!---end Adresse-->
        ...
        <div class="row" style="margin-left: 5% !important; ">
          <?php
        $i=1;
        $folder = "uploads/tasrihNaiss/".$result["numero"].".".$result["annee"]."/";
        $images = glob($folder."*.*");
      ...
      <!--show the slected images-->
                              <form action="uploadTasrihBirthDB.php" class="dropzone" id="myAwesomeDropzone">
          ...
          <h3> أنقر لتحميل الملفات </h3>
                        ...
                        <form  action="selectedTasrihNaissP.php" method="post">
                        <div style="text-align: center;margin-right: 17%;">
                          ...
                          <input type="hidden" name="annee" value="<?php echo $_SESSION['annee'] ?>">
                           ...
                           <button class="btn btn-info m-margin-left" data-numero="<?php echo $result["numero"]?>" data-annee="<?php echo $result["annee"] ?>" id="delTasrihBirth">
                                 <span class="btn-label">
...
<script src="assets/js/lightbox.js"></script>
   ...
   <script>
      ...
      $(document).ready(function(){
          ...
          $(document).on('click', '#delTasrihBirth', function(e){
