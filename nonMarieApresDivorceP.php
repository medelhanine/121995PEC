    ...
    class Pdf extends Fpdi\TcpdfFpdi
    {
        ...
        function Header()
        {
            if (is_null($this->tplId)) {
                $this->setSourceFile('imprimeModels/non_remariage_apres_divorce_ar.pdf');
...
if($language=="fr_divorce")
{
  class Pdf extends Fpdi\TcpdfFpdi
  {
      ...
      {
          if (is_null($this->tplId)) {
              $this->setSourceFile('imprimeModels/non_remariage_apres_divorce_fr.pdf');
              $this->tplId = $this->importPage(1);
          }
          $size = $this->useImportedPage($this->tplId,  0, 0, 150);
