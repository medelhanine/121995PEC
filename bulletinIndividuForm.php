...
<body class="rtl-layout"  style="overflow: hidden !important">
    ...
    <div class="sidebar" data-background-color="gray">
        ...
        <div class="main-panel">
          <nav class="navbar navbar-default navbar-absolute" data-topbar-color="blue">
            ...
            <div class="content">
               ...
               <!--end modal acte deces-->
                            <div class="card">
                              <div class="card-header m-card-title-print">
                                 <h3 class="droid-arabic-kufi"> معلومات البطاقة الشخصية </h3>
                              </div>
							          <div class="card-content">

                          <form action="bulletinIndividuP.php" method="get" >

									<div class="row col-md-11 m-form-saisie">
                    <div class="col-md-4 " style="margin-left: 32% ">
                      <select id="languageSelector" name="language" class="selectpicker m-label-form" data-style="btn btn-info btn-round" title="الجنس" data-size="7" >
                      ...
                      <div class="form-group label-floating">
    										<label class="control-label m-label-form droid-arabic-kufi"> السنة </label>
    										<input type="text" name="annee"  id="anneeBulettin" class="form-control data">
    									</div>
										</div>
									...
									<div class="form-group label-floating">
										<label class="control-label m-label-form droid-arabic-kufi">الرقم </label>
										<input type="text" name="numero" id="numeroBulettin" class="form-control data">
									</div>
									</div>
                  ...
                  <div class="col-md-6" id="prenom_ar">
                <div class="form-group label-floating">
              ...
              <div class="col-md-6" id="date_naiss_miladi_ar">
            <div class="form-group label-floating">
              ...
              <div class="col-md-6" id="date_naiss_hijri_ar">
                <div class="form-group label-floating">
              ...
              <div class="col-md-6" id="date_naiss_miladi_fr">
            <div class="form-group label-floating">
              <label class="control-label m-label-form droid-arabic-kufi"> الميلادي (بالفرنسية)</label>
              <input type="text" name="date_naiss_miladi_fr"  class="form-control m-input-fr">
            </div>
            </div>
              <div class="col-md-6" id="date_naiss_hijri_fr">
                <div class="form-group label-floating">
                  <label class="control-label m-label-form droid-arabic-kufi"> تاريخ الإزدياد الهجري (بالفرنسية) </label>
                  <input type="text" name="date_naiss_hijri_fr"  class="form-control m-input-fr">
                </div>
              </div>


            <div class="col-md-6" id="lieu_naiss">
              <div class="form-group label-floating m-input-fr">
            ...
            <div class="col-md-6" id="lieu_naiss_ar">
          <div class="form-group label-floating">
          ...
          <div class="col-md-6" id="nom_pere">
            <div class="form-group label-floating m-input-fr">
          ...
          <div class="col-md-6" id="nom_pere_ar">
        <div class="form-group label-floating">
      ...
      <div class="col-md-6" id="domicile_ar">
    <div class="form-group label-floating">
      ...
      <div class="col-md-6" id="mention_marge">
        <div class="form-group label-floating m-input-fr">
          <label class="control-label m-label-form droid-arabic-kufi"> Mentions Marginales</label>
          <input type="text" name="mention_marge"  class="form-control">
        </div>
      </div>
      <div class="col-md-6" id="mention_marge_ar">
    <div class="form-group label-floating">
      <label class="control-label m-label-form droid-arabic-kufi"> البيانات الهامشية </label>
      <input type="text" name="mention_marge_ar"  class="form-control">
    </div>
    </div>
