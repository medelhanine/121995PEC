             ...
             <div class="container-fluid">
                <div class="collapse navbar-collapse">
                   <ul class="nav navbar-nav navbar-right">
                     ...
                     <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="modal" data-target="#etatCivilModal" rel="tooltip" title=" معلومات الحالة المدنية " data-placement="bottom">
                     ...
                     <!--etat civil modal Add-->
                     <div class="modal fade " id="etatCivilModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                        <div class="modal-dialog  m-modal-margin" role="document" style="margin-top: 100px !important;">
                           <div class="modal-content">
                              ...
                              <div class="modal-body">
                                 <!--searhc with num-->
                                 <form action="searchVieCollectEtatCivilDB.php" method="post" class="searchEtatCivilForm">
               ...
               <!--end modal acte deces-->
                            <div class="card">
                                ...
                                <div class="card-content">
								                          <div class="row">
                                            <h3 class="droid-arabic-kufi"> معلومات شهادة الحياة الجماعية </h3>
                                        <div class="col-md-9">
                                           <form action="vieCollectInfoP.php" method="post" class="vieCollectForm">
                                                ...
                                                <div class="tab-pane active" id="infoRasm">
                                                   ...
                                                   <div class="row col-md-11 m-form-saisie">
                                                     ...
                                                     <div class="col-md-4 " style="margin-left: 40% ">
                                                       <select name="language" class="selectpicker m-label-form" data-style="btn btn-info btn-round"title=" اختيار اللغة " data-size="7" >
									...
									<div class="form-group label-floating">
										...
										<input type="text" name="numero_certificat"  class="form-control">
									</div>
									</div>
									...
									<div class="form-group label-floating">
										...
										<input type="text" name="numero_mokadam_cheikh"  class="form-control">
									</div>
									</div>
									...
									<div class="form-group label-floating">
										...
										<input type="text" name="date_certficat"  class="form-control datepicker" value="<?php echo $ActualDate ?>" >
									</div>
									</div>
									...
									<div class="col-md-6">
										...
										<input type="text" name="mokadam_cheikh"  class="form-control">
									</div>
										</div>
										<div class="col-md-6">
									<div class="form-group label-floating">
										...
										<input type="text" name="mokadam_cheikh_ar"  class="form-control">
												...
												<div class="form-group label-floating">
													...
													<input type="text" name="prenom_pere_ar"  class="form-control">
												</div>
												</div>
                                                  <!--end add father-->
                                                  ...
                                                  <div class="col-md-6">
                        													...
                        													<div class="col-md-6">
                        												<div class="form-group label-floating">
                        													<label class="control-label m-label-form droid-arabic-kufi childData">  الإسم الشخصي </label>
                        													<input type="text" name="prenom_ar"  class="form-control"  id="prenom_ar">
                        												</div>
                        												</div>
                                                ...
                                                <div class="col-md-6">
                                              <div class="form-group label-floating">
                                                <label class="control-label m-label-form droid-arabic-kufi childData">  الإسم العائلي </label>
                                              ...
                                              <div class="col-md-6">
                                            <div class="form-group label-floating">
                                              <label class="control-label m-label-form droid-arabic-kufi childData"> مكان الإزدياد </label>
                                              <input type="text" name="lieu_naiss_ar"  class="form-control"  id="lieu_naiss_ar">
                                            </div>
                                            </div>
												...
												<div class="form-group label-floating">
													...
													<input type="text" name="prenom_ar"  class="form-control datepicker childData" value="25/03/2018" id="dateNaiss">
												</div>
												</div>

                                                 <div class="row">
                                                 	<button type="button" class="btn btn-success" style="margin-right: 3%" id="addChild">
                      													  <span class="btn-label">
                                                 ...
                                                 <div class="row">
                                                   <h3 class="droid-arabic-kufi"> معلومات الأبناء </h3>
...
<script>
	...
	//append the content of input form(nom and date naiss)
		...
		if(i<=16)
			{
                ...
                <input type="hidden" name="child_prenom_ar`+i+`" value="`+$('#prenom_ar').val()+`" >
                <input type="hidden" name="child_prenom`+i+`" value="`+$('#prenom').val()+`" >
                <input type="hidden" name="child_nom_ar`+i+`" value="`+$('#nom_ar').val()+`" >
                <input type="hidden" name="child_nom`+i+`" value="`+$('#nom').val()+`" >
                <input type="hidden" name="child_lieu_naiss_ar`+i+`" value="`+$('#lieu_naiss_ar').val()+`" >
                <input type="hidden" name="child_lieu_naiss`+i+`" value="`+$('#lieu_naiss').val()+`" >
                <input type="hidden" name="child_date_naiss`+i+`" value="`+$('#dateNaiss').val()+`" >
                <td> الإبن رقم`+i+`</td>
                <td>`+$('#prenom_ar').val()+`</td>
                <td>`+$('#prenom').val()+`</td>
                <td>`+$('#lieu_naiss_ar').val()+`</td>
                <td>`+$('#lieu_naiss').val()+`</td>
                <td>`+$('#dateNaiss').val()+`</td>
                </tr>
                `);
				i++;
                $('#prenom_ar,#prenom,#nom_ar,#nom,#lieu_naiss_ar,#lieu_naiss').val('');
			}
  });
