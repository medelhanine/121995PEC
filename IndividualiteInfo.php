               ...
               <!--end modal acte deces-->
                            <div class="card">
                              <div class="card-header m-card-title-print">
                                <h3 class="droid-arabic-kufi">معلومات شهادة مطابقة الإسم </h3>
                        ...
                        -->
                                      <li >
                                          <a href="#externe" role="tab" data-toggle="tab">
                                        ...
                                        <li class="active">
                                            <a href="#interne" role="tab" data-toggle="tab">
                                              <h3 class="droid-arabic-kufi" style="margin-top:11%">
                                                القاطنين
                                              </h3>
                                  ...
                                  <div class="row col-md-11 m-form-saisie">
                                    <div class="col-md-4 " style="margin-left: 32% ">
                                      <select id="languageSelector" name="language" class="selectpicker m-label-form" data-style="btn btn-info btn-round" title=" اختيار اللغة " data-size="7" >
                                        <option  value="ar"  class="m-label-form" selected> العربية (للقاطنين) </option>
                                ...
                                <div class="tab-pane" id="externe"><!--death tab-->
                                  ...
                                  <div class="row col-md-11 m-form-saisie">
                                    <div class="col-md-4 " style="margin-left: 32% ">
                                      <select id="languageSelectorDeath" name="language" class="selectpicker m-label-form" data-style="btn btn-info btn-round" title="الجنس" data-size="7" >
                                        <option  value="ar_death"  class="m-label-form" selected> العربية (للجالية)</option>
