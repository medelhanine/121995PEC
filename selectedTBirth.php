...
if($pdoResult->rowCount()>0)
{
									...
									<form action="insertToraBirthDB.php" method="post" class="tBirthInsertForm">
									<div class="addedTora">
...
<script>
	...
	$("#addTorra").click(function () {
				...
				$(".addedTora").append(`<input type="hidden" name="numero" value="<?php echo $request["numero"] ?>">
        <input type="hidden" name="annee" value="<?php echo $request["annee"] ?>">
        <div class="row">
        <div class="form-group">
        <h4 class="droid-arabic-kufi">  إضافة طرة جديدة</h4>
        <div class="col-md-6">
        <textarea class="form-control m-input-fr" row="5"  name="content_fr" placeholder="Le contenu..."></textarea></div>

        
        <div class="col-md-6"> <textarea class="form-control" row="5"  name="content_ar" placeholder="محتوى الطرة"></textarea></div></div></div>
        <button type="submit" class="btn btn-danger m-margin-left">
        <span class="btn-label"><i class="material-icons">save</i></span><b class="droid-arabic-kufi">حفظ الطرة الجديدة</b></button>`);
  ...
  $(document).ready(function(){
  	...
  	$(document).on('click', '#delTBirth', function(e){
